            ...
            <div class="row">
                <div class="col-12 text-center mb-2">
                    <ul class="list-inline mb-4" id="portfolio-flters">
                        ...
                        <li class="btn btn-sm btn-outline-danger m-1" data-filter=".laravel">Laravel</li>
                        <li class="btn btn-sm btn-outline-danger m-1" data-filter=".second">WordPress</li>
                        <li class="btn btn-sm btn-outline-danger m-1" data-filter=".third">PHP</li>
                    </ul>
                </div>
            </div>
            <div class="row portfolio-container">
                <div class="col-lg-4 col-md-6 mb-4 portfolio-item laravel">
                    <div class="position-relative overflow-hidden mb-2">
                        <img class="img-fluid rounded w-100" src="{{ asset('frontend/img/larablog.png')}}" alt="">
                        <div class="portfolio-btn bg-danger d-flex align-items-center justify-content-center">
                            <a href="https://blog001-project.ifeanyiojo.com/blog" target="_blank">
